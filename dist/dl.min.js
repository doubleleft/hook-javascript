...
return he(d,function(b,c){d.prototype[c]||(a[c]=b)}),a}(),!1),d.first=pc,d.last=uc,d.sample=fc,d.take=pc,d.head=pc,he(d,function(a,b){var c="sample"!==b;d.prototype[b]||(d.prototype[b]=function(b,d){var e=this.__chain__,f=a(this.__wrapped__,b,d);return e||null!=b&&(!d||c&&"function"==typeof b)?new p(f,e):f})}),d.VERSION="2.4.1",d.prototype.chain=kd,d.prototype.toString=ld,d.prototype.value=md,d.prototype.valueOf=md,Yb(["join","pop","shift"],function(a){var b=xd[a];d.prototype[a]=function(){var a=this.__chain__,c=b.apply(this.__wrapped__,arguments);return a?new p(c,a):c}}),Yb(["push","reverse","sort","unshift"],function(a){var b=xd[a];d.prototype[a]=function(){return b.apply(this.__wrapped__,arguments),this}}),Yb(["concat","slice","splice"],function(a){var b=xd[a];d.prototype[a]=function(){return new p(b.apply(this.__wrapped__,arguments),this.__chain__)}}),d}var o,p=[],q=[],r=0,s=+new Date+"",t=75,u=40,v=" 	\f ﻿\n\r\u2028\u2029 ᠎             　",w=/\b__p \+= '';/g,x=/\b(__p \+=) '' \+/g,y=/(__e\(.*?\)|\b__t\)) \+\n'';/g,z=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,A=/\w*$/,B=/^\s*function[ \n\r\t]+\w/,C=/<%=([\s\S]+?)%>/g,D=RegExp("^["+v+"]*0+(?=.$)"),E=/($^)/,F=/\bthis\b/,G=/['\n\r\t\u2028\u2029\\]/g,H=["Array","Boolean","Date","Function","Math","Number","Object","RegExp","String","_","attachEvent","clearTimeout","isFinite","isNaN","parseInt","setTimeout"],I=0,J="[object Arguments]",K="[object Array]",L="[object Boolean]",M="[object Date]",N="[object Function]",O="[object Number]",P="[object Object]",Q="[object RegExp]",R="[object String]",S={};S[N]=!1,S[J]=S[K]=S[L]=S[M]=S[O]=S[P]=S[Q]=S[R]=!0;var T={leading:!1,maxWait:0,trailing:!1},U={configurable:!1,enumerable:!1,value:null,writable:!1},V={"boolean":!1,"function":!0,object:!0,number:!1,string:!1,undefined:!1},W={"\\":"\\","'":"'","\n":"n","\r":"r","	":"t","\u2028":"u2028","\u2029":"u2029"},X=V[typeof a]&&a||this,Y=V[typeof exports]&&exports&&!exports.nodeType&&exports,Z=V[typeof module]&&module&&!module.nodeType&&module,$=Z&&Z.exports===Y&&Y,_=V[typeof global]&&global;!_||_.global!==_&&_.window!==_||(X=_);var ab=n();"function"==typeof define&&"object"==typeof define.amd&&define.amd?(X._=ab,define(function(){return ab})):Y&&Z?$?(Z.exports=ab)._=ab:Y._=ab:X._=ab}.call(this);var b={VERSION:"0.1.0",defaults:{perPage:50}};a.DL=b,b.Client=function(a){this.url=a.url||"http://dl-api.dev/api/public/index.php/",this.appId=a.appId,this.key=a.key,this.keys=new b.KeyValues(this),this.auth=new b.Auth(this)},b.Client.prototype.collection=function(a){return new b.Collection(this,a)},b.Client.prototype.post=function(a,b){return"undefined"==typeof b&&(b={}),this.request(a,"POST",b)},b.Client.prototype.get=function(a,b){return this.request(a,"GET",b)},b.Client.prototype.put=function(a,b){return this.request(a,"PUT",b)},b.Client.prototype.delete=function(a){return this.request(a,"DELETE")},b.Client.prototype.request=function(c,d,e){var f,g,h,i=when.defer();return e&&(f=JSON.stringify(e),"GET"===d&&(f=encodeURIComponent(f))),g={"X-App-Id":this.appId,"X-App-Key":this.key,"Content-Type":"application/json"},h=a.localStorage.getItem(this.appId+"-"+b.Auth.AUTH_TOKEN_KEY),h&&(g["X-Auth-Token"]=h),uxhr(this.url+c,f,{method:d,headers:g,success:function(a){var b=JSON.parse(a);!b||b.error?i.resolver.reject(b):i.resolver.resolve(b)},error:function(a){var b=JSON.parse(a);console.log("Error: ",b),i.resolver.reject(b)}}),i.promise},b.Client.prototype.serialize=function(a,b){var c=[];for(var d in a)if(a.hasOwnProperty(d)){var e=b?b+"["+d+"]":d,f=a[d];c.push("object"==typeof f?this.serialize(f,e):encodeURIComponent(e)+"="+encodeURIComponent(f))}return c.join("&")},b.Iterable=function(){},b.Iterable.prototype={each:function(a){return this._iterate("each",a)},find:function(a){return this._iterate("find",a)},filter:function(a){return this._iterate("filter",a)},max:function(a){return this._iterate("max",a)},min:function(a){return this._iterate("min",a)},every:function(a){return this._iterate("every",a)},reject:function(a,b){return this._iterate("reject",a,b)},groupBy:function(a,b){return this._iterate("groupBy",a,b)},_iterate:function(a,b,c){var d=this;return this.then(function(e){_[a].call(d,e,b,c)}),this}},b.Auth=function(c){this.client=c,this.currentUser=a.localStorage.getItem(this.client.appId+"-"+b.Auth.AUTH_DATA_KEY),this.currentUser&&(this.currentUser=JSON.parse(this.currentUser))},b.Auth.AUTH_TOKEN_KEY="dl-api-auth-token",b.Auth.AUTH_DATA_KEY="dl-api-auth-data",b.Auth.prototype.authenticate=function(a,b){var c,d=this;return"undefined"==typeof b&&(b={}),c=this.client.post("auth/"+a,b),c.then(function(a){d.registerToken(a)}),c},b.Auth.prototype.verify=function(a,b){var c,d=this;return"undefined"==typeof b&&(b={}),c=this.client.post("auth/"+a+"/verify",b),c.then(function(a){d.registerToken(a)}),c},b.Auth.prototype.logout=function(){return this.currentUser=null,a.localStorage.removeItem(this.client.appId+"-"+b.Auth.AUTH_TOKEN_KEY),a.localStorage.removeItem(this.client.appId+"-"+b.Auth.AUTH_DATA_KEY),this},b.Auth.prototype.registerToken=function(c){c.token&&(a.localStorage.setItem(this.client.appId+"-"+b.Auth.AUTH_TOKEN_KEY,c.token.token),delete c.token,this.currentUser=c,a.localStorage.setItem(this.client.appId+"-"+b.Auth.AUTH_DATA_KEY,JSON.stringify(this.currentUser)))},b.Collection=function(a,b){this.client=a,this.name=this._validateName(b),this.reset(),this.segments="collection/"+this.name},b.Collection.prototype=new b.Iterable,b.Collection.prototype.constructor=b.Collection,b.Collection.prototype.create=function(a){return this.client.post(this.segments,{data:a})},b.Collection.prototype.get=function(){return this.client.get(this.segments,this.buildQuery())},b.Collection.prototype.where=function(a,b,c){var d,e="undefined"==typeof c?"=":b,f="undefined"==typeof c?b:c;if("object"==typeof a)for(d in a)a.hasOwnProperty(d)&&(a[d]instanceof Array?(e=a[d][0],f=a[d][1]):f=a[d],this.addWhere(d,e,f));else this.addWhere(a,e,f);return this},b.Collection.prototype.group=function(){return this._group=arguments,this},b.Collection.prototype.count=function(){this.options.aggregation={method:"count",field:null};var a=this.get();return arguments.length>0&&a.then.apply(a,arguments),a},b.Collection.prototype.max=function(a){this.options.aggregation={method:"max",field:a};var b=this.get();return arguments.length>1&&b.then.apply(b,Array.prototype.slice.call(arguments,1)),b},b.Collection.prototype.min=function(a){this.options.aggregation={method:"min",field:a};var b=this.get();return arguments.length>1&&b.then.apply(b,Array.prototype.slice.call(arguments,1)),b},b.Collection.prototype.avg=function(a){this.options.aggregation={method:"avg",field:a};var b=this.get();return arguments.length>1&&b.then.apply(b,Array.prototype.slice.call(arguments,1)),b},b.Collection.prototype.sum=function(a){this.options.aggregation={method:"sum",field:a};var b=this.get();return arguments.length>1&&b.then.apply(b,Array.prototype.slice.call(arguments,1)),b},b.Collection.prototype.first=function(){this.options.first=1;var a=this.get();return a.then.apply(a,arguments),a},b.Collection.prototype.then=function(){var a=this.get();return a.then.apply(a,arguments),a},b.Collection.prototype.reset=function(){return this.options={},this.wheres=[],this.ordering=[],this._group=[],this._limit=null,this._offset=null,this},b.Collection.prototype.sort=function(a,b){return b?"number"==typeof b&&(b=-1===parseInt(b,10)?"desc":"asc"):b="asc",this.ordering.push([a,b]),this},b.Collection.prototype.limit=function(a){return this._limit=a,this},b.Collection.prototype.offset=function(a){return this._offset=a,this},b.Collection.prototype.stream=function(a){return new b.Stream(this,a)},b.Collection.prototype.paginate=function(a,c){var d=new b.Pagination(this);return c||(c=a,a=b.defaults.perPage),this.options.paginate=a,this.get().then(function(a){d._fetchComplete(a),c&&c(d)}),d},b.Collection.prototype.drop=function(){return this.client.delete(this.segments)},b.Collection.prototype.delete=function(a){return this.client.delete(this.segments+"/"+a)},b.Collection.prototype.update=function(a,b){return this.client.post(this.segments+"/"+a,{data:b})},b.Collection.prototype.increment=function(a,b){this.options.operation={method:"increment",field:a,value:b};var c=this.client.put(this.segments,this.buildQuery());return arguments.length>0&&c.then.apply(c,arguments),c},b.Collection.prototype.decrement=function(a,b){this.options.operation={method:"decrement",field:a,value:b};var c=this.client.put(this.segments,this.buildQuery());return arguments.length>0&&c.then.apply(c,arguments),c},b.Collection.prototype.updateAll=function(a){return this.options.data=a,this.client.put(this.segments,this.buildQuery())},b.Collection.prototype.addWhere=function(a,b,c){return this.wheres.push([a,b,c]),this},b.Collection.prototype._validateName=function(a){var b=/^[a-z_]+$/;if(!b.test(a))throw new Error("Invalid name: "+a);return a},b.Collection.prototype.buildQuery=function(){var a={};null!==this._limit&&(a.limit=this._limit),null!==this._offset&&(a.offset=this._offset),this.wheres.length>0&&(a.q=this.wheres),this.ordering.length>0&&(a.s=this.ordering),this._group.length>0&&(a.g=this._group);var b,c={paginate:"p",data:"d",first:"f",aggregation:"aggr",operation:"op"};for(b in c)this.options[b]&&(a[c[b]]=this.options[b]);return this.reset(),a},b.Files=function(a){this.client=a},b.Files.prototype.upload=function(a,b){this.client.post("/files",b)},b.Files.prototype.get=function(a){return this.client.get("/files",{_id:a})},b.KeyValues=function(a){this.client=a},b.KeyValues.prototype.get=function(a,b){var c=this.client.get("key/"+a);return b&&c.then.apply(c,[b]),c},b.KeyValues.prototype.set=function(a,b){return this.client.post("key/"+a,{value:b})},b.Pagination=function(a){this.fetching=!0,this.collection=a},b.Pagination.prototype._fetchComplete=function(a){this.fetching=!1,this.total=a.total,this.per_page=a.per_page,this.current_page=a.current_page,this.last_page=a.last_page,this.from=a.from,this.to=a.to,this.data=a.data},b.Pagination.prototype.hasNext=function(){return this.current_page<this.to},b.Pagination.prototype.isFetching=function(){return this.fetching},b.Pagination.prototype.then=function(){},b.Stream=function(c,d){d||(d={}),this.collection=c;var e=this.collection.buildQuery();e["X-App-Id"]=this.collection.client.appId,e["X-App-Key"]=this.collection.client.key;var f=a.localStorage.getItem(e["X-App-Id"]+"-"+b.Auth.AUTH_TOKEN_KEY);if(f&&(e["X-Auth-Token"]=f),e.only_new=d.only_new||!1,e.stream={retry:d.retry_timeout||1,refreh:d.refresh_timeout||5},this.event_source=new EventSource(this.collection.client.url+this.collection.segments+"?"+JSON.stringify(e),{withCredentials:!0}),"function"==typeof d)this.on("message",d);else for(var g in d)this.on(g,d[g])},b.Stream.prototype.on=function(a,b){var c=this;return"message"==a?this.event_source.onmessage=function(a){b.apply(c,[JSON.parse(a.data),a])}:this.event_source["on"+a]=function(a){b.apply(c,[a])},this},b.Stream.prototype.close=function(){return this.event_source.close(),this}}(this);