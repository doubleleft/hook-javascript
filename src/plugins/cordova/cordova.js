...
var HookCordova = function(client) {
  ...
  /**
   * @property push
   * @type HookCordova.PushNotification
   */
  this.push = new HookCordova.PushNotification(client);
};
 ...
 * @extends Hook.Events
 */
HookCordova.PushNotification = function(client) {
  var self = this;
...
HookCordova.PushNotification.prototype = new Hook.Events();
HookCordova.PushNotification.constructor = HookCordova.PushNotification;
 ...
 * @method register
 * @return HookCordova.PushNotification
 *
 ...
 *     });
 */
HookCordova.PushNotification.prototype.register = function(options) {
  var self = this,
      name  = null,
      registerOptions = {
        ecb: 'onNotification',
 ...
 * @method unregister
 */
HookCordova.PushNotification.prototype.unregister = function(options) {
};

/**
 * method _registerDevice
 */
HookCordova.PushNotification.prototype._registerDevice = function(id) {
